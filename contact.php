...
<head>
    ...
    <title>Contact Vrinda Green City - Get in Touch for Residential Plots in Bihta, Patna</title>
    <meta name="description"
        content="Contact Vrinda Green City for inquiries about residential plots in Bihta, Patna. Visit our office or call us to learn about plot availability, pricing, and booking procedures.">
    <meta name="keywords"
        content="contact Vrinda Green City, Bihta plots contact, Patna real estate contact, plot inquiry Bihta, Vrinda Green City office, residential plots contact Patna">
...
<body>
    ...
    <main class="main-area fix">
        ...
        <section class="breadcrumb-area breadcrumb-bg"
            style="background-image: url('https://imagizer.imageshack.com/img922/3263/BtzoOh.png');">
            <div class="container">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-9">
                            <div class="contact-box">
                                ...
                                <div class="contact-content">
                                    ...
                                    <p class="contact-desc">+91 9200800600</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-sm-9">
                            <div class="contact-box">
                                ...
                                <div class="contact-content">
                                    ...
                                    <p class="contact-desc">info@vrindagreencity.com <br> vrindagreencity.com</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-xl-6">
                        <div id="contact-map">
                            <iframe
                                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3598.0237636935814!2d85.17628207534203!3d25.60607631600862!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39ed58dce3ddda4b%3A0x52a6011209c009b6!2sBoring%20Rd%2C%20Patna%2C%20Bihar!5e0!3m2!1sen!2sin!4v1700000000000!5m2!1sen!2sin"
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-grp">
                                            ...
                                            <input type="text" id="full-name" name="name" placeholder="Enter here"
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-grp">
                                            ...
                                            <input type="tel" id="phone" name="phone" placeholder="Enter here">
                                            <div class="help-block with-errors"></div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
    ...
    <script>
        $(document).ready(function () {
            // Check if plot parameter exists in URL
            const urlParams = new URLSearchParams(window.location.search);
            const plotNo = urlParams.get('plot');

            if (plotNo) {
                // Pre-fill subject and message for plot inquiry
                $('#subject').val('Plot Booking');
                $('#message').val(`I am interested in Plot ${plotNo} at Vrinda Green City. Please provide more details.`);
