...
(function ($) {
  ...
  function parseCSVData(csvText) {
    ...
    const colIndex = {
      ...
      dimension: headerValues.findIndex((h) =>
        h.toLowerCase().includes("dimension")
      ),
      area: headerValues.findIndex((h) => h.toLowerCase().includes("area")),
      direction: headerValues.findIndex((h) =>
        h.toLowerCase().includes("direction")
      ),
